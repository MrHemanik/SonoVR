Shader "Unlit/BlendSlices"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				fixed4 lineCol = tex2D(lineTex, inp.uv);
				lineCol.a = useLine * lineCol.a; // toggle
				...
				// line overlay
				result = (1 - lineCol.a) * result + (lineCol.a * lineCol);
