...
namespace Classes
{
    public class LevelType
    {
        ...
        public static readonly LevelType[] LevelTypes = new LevelType[]
        {
            ...
            new LevelType(ObjectType.HiddenVolumeAfterimage,ObjectType.Volume, "Untersuche das unsichtbare Volumen und finde heraus, welches der sichtbaren Volumen identisch ist!"),
            new LevelType(ObjectType.Volume,ObjectType.HiddenVolumeAfterimage, "Untersuche die unsichtbaren Volumen und finde heraus, welches identisch zum sichtbaren Volumen ist!"),
            new LevelType(ObjectType.HiddenVolumeAfterimage,ObjectType.Slice, "Untersuche das unsichtbare Volumen und finde heraus, welches der Schnittbilder das Volumen darstellt!"),
            new LevelType(ObjectType.Slice,ObjectType.HiddenVolumeAfterimage, "Untersuche die unsichtbaren Volumen und finde heraus, welches identisch zum sichtbaren Schnittbild ist!"),
