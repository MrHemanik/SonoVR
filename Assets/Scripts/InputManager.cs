...
public class InputManager : MonoBehaviour
{
    ...
    public void OnLeftTrigger(InputAction.CallbackContext context)
    {
        ...
        if (leftController.hasSelection)
        {
            ...
            var infoScript = leftController.interactablesSelected[0].transform.GetComponent<InteractableInformation>();
            if (infoScript == null) return;
            int answerId = infoScript.answerId;
