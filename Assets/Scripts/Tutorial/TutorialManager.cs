...
namespace Tutorial
{
    ...
    public class TutorialManager : MonoBehaviour
    {
        ...
        private readonly String[] tutorialTexts =
        {
            ...
            "Gut gemacht!\nGreif das Volumen mit deiner linken Hand um es hin und her zu bewegen. Beim loslassen bleibt es in der Luft stehen. Drück währenddessen den linken Trigger um es als Antwort abzugeben.\nZur Erinnerung: Die Steuerung ist links von dir erklärt.",
